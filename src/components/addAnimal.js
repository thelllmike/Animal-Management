...
import dashboardimg from './img/dashboard-image.svg'

// import './css/finance.css';
import "./css/AddAnimal.css";

import dashboard from './img/dashboard-image.svg'
export default class addAnimal extends Component {
	...
	onSubmit(e) {
		...
		axios.post("http://localhost:4000/animal/addexpenses", obj).then((res) => {
		...
		return (
			<div className='addanimal'>
				<div class='sidebar'>
					...
					<a href='/'><img src={dashboardimg} alt="" />Visitor Management</a>
					<a href='/'><img src={dashboardimg} alt="" />Project Management</a>
					<a href='/'><img src={dashboardimg} alt="" />Finance Management</a>
					<a href='/'><img src={dashboardimg} alt="" />Inventory Management</a>
					<a href='/'><img src={dashboardimg} alt="" />Handing Medical Records</a>
					<a href='/'><img src={dashboardimg} alt="" />Animal Management</a>
					<a href=''><img src={dashboardimg} alt="" />Volunteer Management</a>
					<a href=''><img src={dashboardimg} alt="" />Employee Management</a>
				</div>
